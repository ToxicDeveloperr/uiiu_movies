...
def register_bot_jobs(scheduler: AsyncIOScheduler):
    ...
    scheduler.add_job(post_n_movies, "cron", args=[4], hour=21, minute=46, timezone=TZ)
    ...
    scheduler.add_job(post_all_remaining, "cron", hour=21, minute=54, timezone=TZ) # Fixed hour 16:02 to 23:55
